...
namespace UnityEditor.U2D.PSD
{
    ...
    public class PSDImporterEditor : ScriptedImporterEditor, ITexturePlatformSettingsDataProvider
    {
        ...
        SerializedProperty m_CreateCanvasObjects;
        ...
        public override void OnEnable()
        {
            ...
            m_CreateCanvasObjects = serializedObject.FindProperty("m_CreateCanvasObjects");
        ...
        void DoSpriteTextureTypeInspector()
        {
            ...
            EditorGUILayout.PropertyField(m_DocumentAlignment, styles.documentAlignment);
            EditorGUILayout.PropertyField(m_GeneratePhysicsShape, styles.generatePhysicsShape);
            EditorGUILayout.PropertyField(m_CreateCanvasObjects, styles.createCanvasObjects);
        ...
        internal class Styles
        {
            ...
            public readonly GUIContent documentAlignment = EditorGUIUtility.TrTextContent("Document Alignment", "Anchor point of root layer.");
            ...
            public readonly GUIContent createCanvasObjects = EditorGUIUtility.TrTextContent("Create Canvas Objects", "Prefab will contain Canvas objects instead of Sprite objects.");
